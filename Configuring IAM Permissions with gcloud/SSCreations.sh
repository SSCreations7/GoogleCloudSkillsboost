...
echo "${CYAN_TEXT}${BOLD_TEXT}      SUBSCRIBE SS CREATIONS- INITIATING EXECUTION...  ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}==================================================================${RESET_FORMAT}"
echo
...
echo "${CYAN_TEXT}${BOLD_TEXT}=======================================================${RESET_FORMAT}"
echo
echo "${RED_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}https://youtube.com/@ss_creations7?si=vrcLS1OIhm8_kJgl${RESET_FORMAT}"
