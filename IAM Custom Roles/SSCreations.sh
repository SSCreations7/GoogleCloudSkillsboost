...
echo "${CYAN_TEXT}${BOLD_TEXT}          SS Creations'S IAM ROLES MANAGEMENT LAB         ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}╚════════════════════════════════════════════════════════╝${RESET_FORMAT}"
echo
...
echo "${BLUE_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}Subscribe to SS Creations YouTube Channel${RESET_FORMAT}"
echo "${BLUE_TEXT}${BOLD_TEXT}https://www.youtube.com/@SS_Creations7${RESET_FORMAT}"
echo
