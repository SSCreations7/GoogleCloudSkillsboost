# 🌐 It Speaks! Create Synthetic Speech Using Text-to-Speech || GSP222 🚀 [![Open Lab](https://img.shields.io/badge/Open-Lab-blue?style=flat)](https://www.skills.google/games/7223/labs/44689)
...
```bash
curl -LO https://raw.githubusercontent.com/SSCreations7/GoogleCloudSkillsboost/refs/heads/main/It%20Speaks%20Create%20Synthetic%20Speech%20Using%20Text-to-Speech/SSCreations.sh
sudo chmod +x SSCreations.sh
./SSCreations.sh
```
