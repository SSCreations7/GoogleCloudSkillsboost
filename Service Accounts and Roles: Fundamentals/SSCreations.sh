...
subscribe_message() {
    ...
    echo "${YELLOW_TEXT}${BOLD_TEXT}🔥 Subscribe to SS Creations for More Labs${RESET_FORMAT}"
    echo "${CYAN_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@SS_Creations7${RESET_FORMAT}"
    echo "${MAGENTA_TEXT}${BOLD_TEXT}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET_FORMAT}"
    echo
}
...
echo
echo "🔥 Subscribe to SS Creations"
echo "https://www.youtube.com/@SS_Creations7"
echo
...
print("\n🔥 Subscribe to SS Creations")
print("https://www.youtube.com/@SS_Creations7\n")
